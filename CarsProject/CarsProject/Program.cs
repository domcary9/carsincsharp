...
namespace CarsProject
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input != "4")
            {
                Console.WriteLine(" Welcome to Dom's Dealership - when life gives you lemons... don't sue Dom");
        ...
        public void AddCar()
        {
            ...
            car.model = model;
            Console.WriteLine("Enter the number of doors on vehicle:");
            ...
            car.price = price;
            cars.Add(car);
            Console.WriteLine("Your case is a: " + car.year.ToString() + " " + car.make + " " + car.model);
        }
